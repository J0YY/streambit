...
let [bankData, assetData, tradeData] = [
  ...
  },
  {
    ...
    title: 'Find An Asset',
    desc:
      'Search for an existing asset with its ticker or name. Click on the asset.',
  ...
  },
  {
    ...
    title: 'Trade',
    desc:
      'Choose the type of trade you would like to make on the asset. Then confirm.',
    ...
    <div className="trade-section">
      <div className="trade-section-title">
        ...
        <Card
          ...
          desc={assetData.desc}
          imgsComponent={assetData.imgsComponent}
        />
      </div>
      <div className="trade-section-cards">
        <Card
          ...
          desc={bankData.desc}
          imgsComponent={bankData.imgsComponent}
        />
        <Card
          style={{ marginTop: '6em' }}
          icon={tradeData.icon}
          ...
          desc={tradeData.desc}
          imgsComponent={tradeData.imgsComponent}
        />
      </div>
    </div>
  );
